  ...
  <v-container class="mx-10 py-10">
    ...
    <v-card class="mx-auto" tile>
      ...
      <v-list-item three-line>
        <v-list-item-content>
          <v-list-item-title
            >Information Security Specialist Examination</v-list-item-title
          >
          <v-list-item-subtitle
            >情報セキュリティスペシャリスト試験</v-list-item-subtitle
          >
          <v-list-item-subtitle
            >IPA: Information-technology Promotion Agency,
            Japan</v-list-item-subtitle
      ...
      <v-list-item three-line>
        <v-list-item-content>
          ...
          <v-list-item-subtitle>
            <a
              href="https://bcert.me/bc/html/show-badge.html?b=mtyhtttd"
              target="_blank"
            >
